...
from "DEVELOPER_DB"."VIKAS_SCHEMA"."STAGE_US_DATA" as a

left outer join "DEVELOPER_DB"."VIKAS_SCHEMA"."US_ACCIDENTS_ADRESS_DIM" b
...
left outer join "DEVELOPER_DB"."VIKAS_SCHEMA"."US_ACCIDENTS_DORN_DIM" c
...
left outer join "DEVELOPER_DB"."VIKAS_SCHEMA"."US_ACCIDENT_REASON_DIM" d
...
left outer join "DEVELOPER_DB"."VIKAS_SCHEMA"."CALENDER"  as z
